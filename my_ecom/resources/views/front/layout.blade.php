            ...
            <div class="aa-header-bottom-area">
              ...
              <!-- / logo  -->
               ...
               @php
                  ...
                  $totalCount = count($getAddToCartTotalItem);
                  $totalPrice = 0;
               @endphp
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cartBox">
                  ...
                  <span class="aa-cart-notify">{{$totalCount}}</span>
                </a>
                ...
                @if($totalCount > 0)
                  <ul>
                    ...
                    @php
                      $totalPrice = $totalPrice + ($cartList->qty*$cartList->price);
                    @endphp
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{asset('storage/media/'.$cartList->image)}}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">{{$cartList->name}}</a></h4>
                        <p>$ {{$cartList->qty}} x {{$cartList->price}}</p>
                      </div>
                    </li>
                    @endforeach                
                    <li>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <div id="popup_forgot" style="display:none;">
            ...
            <form class="aa-login-form" id="frmForgot">
              <label for="">Email address<span>*</span></label>
              <input type="text" placeholder="email" name="str_forgot_email">
              <button class="aa-browse-btn" id="btnForgot" type="submit">Submit</button>
              <div id="forgot_msg"></div>
              <div class="aa-register-now">
                Already Have Account?<a href="javascript:void(0)" onclick="show_popup_login()">Login now!</a>
              </div>
              @csrf
            </form>
          </div>
