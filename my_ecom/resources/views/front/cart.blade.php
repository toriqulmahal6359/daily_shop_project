                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr id="cart_box_{{$data->pid}}">
                        ...
                        <td>${{$data->price}}</td>
                        <td><input id="qty{{$data->pid}}" class="aa-cart-quantity" type="number" value="{{$data->qty}}" onchange="updateQty('{{$data->pid}}','{{$data->size}}','{{$data->color}}','{{$data->attr_id}}','{{$data->price}}')"></td>
                        <td id="total_price_{{$data->pid}}">$ {{$data->price * $data->qty}}</td>
                      </tr>
                      @endforeach
                      <tr>
