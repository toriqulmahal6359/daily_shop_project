                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">        
                        ...
                        <li class="@yield('tax_select')">
                            ...
                            <i class="fas fa-percent" aria-hidden="true"></i>Tax</a>
                        </li>
                        <li class="@yield('product_select')">
                            <a href="{{url('admin/product')}}">
                            <i class="fas fa-gift"></i>Product</a>
                        </li> 
                        <li class="@yield('customer_select')">
                            <a href="{{url('admin/customer')}}">
                            <i class="fas fa-user" aria-hidden="true"></i>Customer</a>
                        </li>
                        <li class="@yield('home_banner_select')">
                            <a href="{{url('admin/home_banner')}}">
                            <i class="fas fa-images" aria-hidden="true"></i>Home Banner</a>
                        </li> 
                    </ul>
                </div>
            </nav>
